...
examples=(sum_evens first_over countdown structs arrays strings bools elseif floats breakcont multifile actor_counter actor_selfheal actor_children exceptions interfaces ffi atoms_tuples lambdas hashmap trycatch javastrings javacollections actor_args switchenum tcpserver)
declare -A want=(
  [sum_evens]=20
  [first_over]=7
  [countdown]=15
