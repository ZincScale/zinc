...
final class PyLexer {
  ...
  // Python keyword spellings mapped onto the existing TokKind set the parser already
  // understands. 'def'/'class'/'in'/'and'/'or'/'not'/'None'/'from' stay IDENT and are
  // matched by text in PyParser (mirrors how Parser treats 'class' as a soft keyword).
