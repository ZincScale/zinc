...
// emitV2ChainedCollection emits a collection chain using _zinc_collect() dispatch.
// Smart data shape dispatch at runtime picks the best backend automatically.
